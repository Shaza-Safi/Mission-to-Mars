...
def scrape_all():
    ...
    hemisphere_image_urls = scrap_hemisphere(browser)
...
def scrap_hemisphere(browser):
    ...
    # hemisphere_image_urls = img_soup.find('a', class_='itemLink product-item').get('src')
    ...
    for item in range(4):
        ...
        # Identify and return title of images
